#
#  Be sure to run `pod spec lint WinkKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Rico Crescenzio" => "rico.crescenzio@gmail.com" }
  # Or just: s.author    = "Rico Crescenzio"
  # s.authors            = { "Rico Crescenzio" => "rico.crescenzio@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Rico Crescenzio"
  ...
  s.source       = { :git => "https://github.com/WINKgroup/WinkKit.git", :tag => "#{s.version}" }
