...
//  CityNews
//
//  Created by Rico Crescenzio on 07/04/17.
//  Copyright © 2017 Wink. All rights reserved.
//

import Foundation

/// An ordered set is basically a `Set` where the order of entries is not random.
